...
var DinnerModel = function() {
  ...
  // Set the number of guests for the dinner to a given value
	...
	// Get the number of guests for the dinner
	this.getNumberOfGuests = function() { return this.numberOfGuests; }

	//Returns the dish that is on the menu for selected type
	this.getSelectedDish = function(type) {
    return this.menu.find(dish => dish.type == type );
	}

	//Returns all the dishes on the menu.
	this.getFullMenu = function() { return this.menu; }
  ...
  this.getIngredientsForDish = function(dish) { return dish.ingredients; }
    ...
    const newDish = dishes.find(dish => dish.id == id);
    if (newDish == undefined) { return; }

    this.menu = this.menu.filter(dish => dish.type != newDish.type);
